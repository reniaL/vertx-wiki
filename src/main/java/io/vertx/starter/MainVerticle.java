...
public class MainVerticle extends AbstractVerticle {
    ...
    private Future<Void> prepareDatabase() {
        ...
        dbClient = JDBCClient.createShared(vertx, new JsonObject().put("url", "jdbc:hsqldb:file:db/wiki").put
                ("driver_class", "org.hsqldb.jdbcDriver").put("max_pool_size", 30));
            ...
            if (car.succeeded()) {
                ...
                connection.queryWithParams(SQL_GET_PAGE, new JsonArray().add(page), fetch -> {
                    ...
                    if (fetch.succeeded()) {
                        ...
                        JsonArray row = fetch.result().getResults().stream().findFirst().orElseGet(() -> new
