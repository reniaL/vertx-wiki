...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    private void pageUpdateHandler(RoutingContext context) {
        ...
        JsonObject request = new JsonObject().put("id", context.request().getParam("id")).put("title", title).put
                ("markdown", context.request().getParam("markdown"));
